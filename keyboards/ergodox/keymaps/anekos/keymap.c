...
[_BASE] = KEYMAP(  // layer 0 : default
        ...
        LO_ESC,  _______, _______, KC_MINS, BT_ESC,
        ...
        // right hand
             ...
             KC_ENT,  KC_N,    KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                               BT_ESC, KC_MINS, _______, _______, RA_ENT,
...
[_RAISE] = KEYMAP(
       ...
       _______, KC_WH_U, KC_MS_U, KC_WH_D, RESET,   _______, _______,
       ...
       // right hand
       _______, CON6,    CON7,    CON8,    CON9,    CON10,   _______,
       _______, _______, _______, _______, _______, _______, _______,
