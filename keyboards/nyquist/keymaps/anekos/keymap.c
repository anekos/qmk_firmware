 ...
 */
[LR5] = KEYMAP(
  TO_0,    _______, _______, _______, _______, _______, KC_C,    KC_D,    KC_E,    KC_F,    KC_SLSH, KC_BSPC, \
  _______, _______, _______, _______, _______, _______, KC_B,    KC_7,    KC_8,    KC_9,    KC_ASTR, KC_BSPC, \
  _______, _______, _______, _______, _______, _______, KC_A,    KC_4,    KC_5,    KC_6,    KC_MINS, KC_SCLN, \
